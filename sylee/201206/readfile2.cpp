...
void readfile() {
    ...
    while (index < size) {
        ...
        // ---------------- 출력 부분 --------------------------
        cout << "\ncur  : ";
        for (it = list_cur.begin(); it != list_cur.end(); ++it) {
            cout << *it;
        }
        cout << endl;
        cout << list_cur.size() << endl;
        cout << "next : ";
        for (it = list_next.begin(); it != list_next.end(); ++it) {
            cout << *it;
        }
        // cout << "cur  : " << arr_cur << endl;
        // cout << "next : " << arr_next << endl;
        cout << endl;
        cout << list_next.size() << endl;
    }
}
